...
namespace ShopExpress {
    ...
    public partial class userData : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(int userID, string genderCategory, int categoryID, string productName, string size, double price, int colorID) {
...
namespace ShopExpress.userDataTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([productID] = @Original_productID) AND ([userID] = @Original_userID) AND ([genderCategory] = @Original_genderCategory) AND ([categoryID] = @Original_categoryID) AND ([productName] = @Original_productName) AND ([size] = @Original_size) AND ([price] = @Original_price) AND ([colorID] = @Original_colorID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [userID] = @userID, [genderCategory] = @genderCategory, [categoryID] = @categoryID, [productName] = @productName, [size] = @size, [price] = @price, [colorID] = @colorID WHERE (([productID] = @Original_productID) AND ([userID] = @Original_userID) AND ([genderCategory] = @Original_genderCategory) AND ([categoryID] = @Original_categoryID) AND ([productName] = @Original_productName) AND ([size] = @Original_size) AND ([price] = @Original_price) AND ([colorID] = @Original_colorID));
SELECT productID, userID, genderCategory, categoryID, productName, size, price, colorID FROM Product WHERE (productID = @productID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT productID, userID, genderCategory, categoryID, productName, size, price, c" +
                "olorID FROM dbo.Product";
        ...
        public virtual int Fill(userData.ProductDataTable dataTable) {
        ...
        public virtual userData.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            userData.ProductDataTable dataTable = new userData.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(userData.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_productID, int Original_userID, string Original_genderCategory, int Original_categoryID, string Original_productName, string Original_size, double Original_price, int Original_colorID) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_colorID));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(colorID));
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_colorID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int userID, string genderCategory, int categoryID, string productName, string size, double price, int colorID, int Original_productID, int Original_userID, string Original_genderCategory, int Original_categoryID, string Original_productName, string Original_size, double Original_price, int Original_colorID) {
            return this.Update(userID, genderCategory, categoryID, productName, size, price, colorID, Original_productID, Original_userID, Original_genderCategory, Original_categoryID, Original_productName, Original_size, Original_price, Original_colorID, Original_productID);
        }
    }
