...
namespace ShopExpress.userTableAdapters {
...
SELECT productID, userID, genderCategory, categoryID, productName, productDescription, size, picture, price, colorID FROM Product WHERE (productID = @productID)";
        ...
        public virtual int Fill(user.ProductDataTable dataTable) {
        ...
        public virtual user.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            user.ProductDataTable dataTable = new user.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(user.ProductDataTable dataTable) {
